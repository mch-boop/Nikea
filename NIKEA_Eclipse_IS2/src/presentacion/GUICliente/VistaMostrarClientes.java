	...
	public void actualizar(int evento, Object datos) {
		SwingUtilities.invokeLater(() -> {
			...
			case Eventos.RES_MOSTRAR_CLIENTES_OK:
				...
				if (lista.isEmpty()) {
					JOptionPane.showMessageDialog(VistaMostrarClientes.this,
							"No hay clientes registrados en el sistema.", "Información",
							JOptionPane.INFORMATION_MESSAGE);
				} else {

					for (TCliente tc : lista) {
						Object[] fila = { tc.getId(), tc.getDNI(), tc.getNombre() + " " + tc.getApellidos(),
			...
			case Eventos.RES_MOSTRAR_CLIENTES_KO:
				modeloTabla.setRowCount(0);
				JOptionPane.showMessageDialog(VistaMostrarClientes.this, "Error al recuperar la lista de clientes.",
